...
# Custom Mapping
The game uses [Trenchbroom](https://trenchbroom.github.io/) for its map design.
you can use these tutorials: 
https://youtu.be/_FFYBkMka60?si=KQSPaFGSVHHUCN59
https://youtu.be/qvEUC-TjToo?si=PesBYkpjOcsSGXY4
Custom mapping support is being worked on.

# Modding
Modding / Forking the game is compeletely allowed but contact me on Discord / Twitter so i am aware of it. (@plumoblong on both platforms)
If you use/modify any code from this project please credit!
